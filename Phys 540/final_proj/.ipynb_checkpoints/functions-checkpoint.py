...
class PETImage:
    ...
    def get_probability_sinogram(self):
        self.PET_im_sino_prob = estimate_prob_of_detections_sino(self.PET_im_sino_rs_bins,
                                                                 ...
                                                                 self.CT_im, num=1000)
    def get_recon_data(self, algo_names, masks, masks_name, correction, num_iters, every_ns):
        self.recon_datas = {}
        sino = self.PET_im_sino/self.PET_im_sino_prob
        for algo_name, num_iter, every_n in zip(algo_names, num_iters, every_ns):
            print(algo_name)
